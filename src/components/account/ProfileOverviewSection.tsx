          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
            {history.slice(0, 4).map((item: any) => {
              ...
              return (
                <div
                  key={item.id}
                  className="group relative bg-slate-900/60 border border-white/10 rounded-2xl overflow-hidden hover:border-white/20 transition-all flex flex-col"
                >
                  <div className="relative aspect-[16/9] w-full bg-slate-800 overflow-hidden">
                    ...
                    <div className="absolute bottom-2 left-2 right-2 flex items-center justify-between text-[11px] font-bold text-white">
                      ...
                      {progressPct !== null && (
                        <span className="bg-blue-600/80 backdrop-blur-md px-1.5 py-0.5 rounded-md text-[10px]">
                          {progressPct}%
                        </span>
                      )}
                    </div>
                  ...
                  <div className="p-3 flex-1 flex flex-col justify-between">
                    <Link
                      ...
                      className="font-bold text-xs text-white line-clamp-1 hover:text-blue-400 transition-colors"
                    >
